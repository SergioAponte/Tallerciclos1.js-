...
// while (estudiante!=''){
//     let nota1=parseFloat(prompt('digite la nota 1'))
//     let nota2=parseFloat(prompt('digite la nota 2'))
//     let nota3=parseFloat(prompt('digite la nota 3'))
//     let nota4=parseFloat(prompt('digite la nota 4'))
//     let nota5=parseFloat(prompt('digite la nota 5'))
